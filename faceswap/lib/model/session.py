...
class KSession():
    ...
    def __init__(self,
        ...
        print(f"\nInitializing: {self.__class__.__name__} (name: {name}, model_path: {model_path}, model_kwargs: {model_kwargs},  allow_growth: {allow_growth}, exclude_gpus: {exclude_gpus}, cpu_mode: {cpu_mode})")
        ...
        # print("\nInitialized:", self.__class__.__name__,)  # type:ignore
    ...
    def load_model(self) -> None:
        ...
        # print("\nInitializing plugin model:", self._name)  # type:ignore
        with self._context:
